...
moodle_users_new_main_page_url = 'http://52.39.5.126/admin/user.php'
moodle_users_new_main_page_title = 'SQA: Administration: Users: Accounts: Browse list of users'

admin_username = 'svetlanaglazyrina'
admin_password = 'Cleopatr@2012'
...
id_idnumber = fake.pyint(111111,9919999)
...
lst_opt = ['Web page', 'ICQ number', 'Skype ID', 'AIM ID', 'Yahoo ID', 'MSN ID', 'ID number', 'Institution', 'Department', 'Phone Mobile', 'Mobile phone', 'Address']
